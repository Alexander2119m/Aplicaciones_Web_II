...
class DetallePedidoController {
    constructor() {
        ...
        this.createDetallePedido = (req, res) => __awaiter(this, void 0, void 0, function* () {
            const [error, createDetallePedidoDto] = domain_1.CreateDetallePedidoDto.create(req.body);
            if (error)
        ...
        this.updateDetallePedido = (req, res) => __awaiter(this, void 0, void 0, function* () {
            const iddetalle = +req.params.id;
            const [error, updateDetallePedidoDto] = domain_1.UpdateDetallePedidoDto.create(Object.assign(Object.assign({}, req.body), { iddetalle }));
            if (error)
                return res.status(400).json({ error });
            const detalle = yield postgres_1.prisma.detallePedido.findFirst({
                where: { iddetalle },
