...
class PedidosController {
    constructor() {
        ...
        this.createPedido = (req, res) => __awaiter(this, void 0, void 0, function* () {
            const [error, createPedidoDto] = domain_1.CreatePedidoDto.create(req.body);
            if (error)
        ...
        this.updatePedido = (req, res) => __awaiter(this, void 0, void 0, function* () {
            const idpedido = +req.params.id;
            const [error, updatePedidoDto] = domain_1.UpdatePedidoDto.create(Object.assign(Object.assign({}, req.body), { idpedido }));
            if (error)
                return res.status(400).json({ error });
            const pedido = yield postgres_1.prisma.pedido.findFirst({
                where: { idpedido },
